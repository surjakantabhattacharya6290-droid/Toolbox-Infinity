...
export const TOOLS: ToolMeta[] = [
  ...
  { id: 'jwt-decoder', name: 'JWT Decoder', shortName: 'JWT', description: 'Decode JWT tokens and inspect header/payload', icon: 'Keyhole', theme: 'matrix', category: 'security', categoryLabel: 'Security & Crypto', keywords: ['jwt', 'token', 'decode', 'auth', 'bearer', 'json web token'] },
